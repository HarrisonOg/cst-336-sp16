...
// Set the Cloud 9 MySQL related information...this is set in stone by C9!
    ...
    echo "<br /><br /> Performing: $stmt <br /><br />";
    ...
    //******************PART B
    //Structure the select
    $partBsql = "SELECT * FROM `m_gradebook` INNER JOIN `m_students` ON `m_students`.studentId=`m_gradebook`.studentId WHERE `grade` < 50 ORDER BY `grade`";
     // Prepare the SQL...the DBMS uses this to figure out how best to execute the query
    ...
    echo "<br /><br /> Performing: $Bstmt <br /><br />";
